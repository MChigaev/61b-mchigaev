...
public class LinkedListDequeTest {
    ...
    public static class Comp implements java.util.Comparator<Integer> {
    ...
    public void bigLLDequeTest() {
        ...
        Comp c = new Comp();
        MaxArrayDeque<Integer> lld4 = new MaxArrayDeque<Integer>(c);
        LinkedListDeque<Integer> lld3 = new LinkedListDeque<Integer>();
        lld3.addFirst(3);
        lld4.addFirst(1);
        lld4.addLast(2);
        lld4.addFirst(5);
        System.out.println(lld4.max());
        ...
        lld2.addFirst(5);
        //lld2.printDeque();
        java.util.Iterator x = lld2.iterator();
        ...
        System.out.println(lld3.equals(lld3));
